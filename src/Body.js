  ...
  return(
    <div>
      <div className="flex justify-between">
          <h1 className="m-5 ">Top Restaurants </h1>
          <div className="m-5">
              <button onClick={() => {const filteredList = listOfRestaurants.filter((res) => res.data.avgRating > 4); setListOfRestaruants(filteredList)
              }}>Top Rated Restarunats</button>
              <input type="text" placeholder="Restaurants" value={searchText} onChange={(e) => setSearchText(e.target.value)}  />
